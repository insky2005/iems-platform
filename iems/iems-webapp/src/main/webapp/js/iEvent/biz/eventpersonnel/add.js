...
$(function() {
	...
	*/
	...
	var oDataInit = {'eventPersonnel': {'companyid': companyid, 'eventid': eventid}};
    ...
    $.scojs_valid('#form_data', 
		{
			...
			rules: {
				'eventPersonnel.name': ['not_empty'],
				'eventPersonnel.duty': [{'max_length': 200}],
				'eventPersonnel.memo': [{'max_length': 200}],
