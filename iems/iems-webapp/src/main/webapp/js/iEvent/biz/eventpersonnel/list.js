/**
 * iEvent.biz.eventpersonnel.list.js
 */
...
$(function() {
	...
	var oSettings = $.extend({}, iEvent.DataTable.defaults, {
		"aoColumns": [
			...
			{ "mData": "eventPersonnel.type" },
			{ "mData": "eventPersonnel.name" },
			{ "mData": "eventPersonnel.telephone" },
			{ "mData": "eventPersonnel.email" },
			{ "mData": "eventPersonnel.mobile" },
			{ "mData": "eventPersonnel.id", 
