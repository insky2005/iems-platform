...
<html>
  <head>
		<meta charset="UTF-8">
		<title>${systemName } | EventInfo - Edit</title>
                                  ...
                                  <div class="col-xs-12">
                                    <div class="row">
                                        <div class="col-xs-4 form-group h_90px">
                                            ...
                                            <label>
                                                <input type="radio" name="eventStaff.type" class="minimal" value="2" /> 工作人员
                                            </label>
                                            </div>
                                        </div>
  ...
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <script src="${ctx }/js/iEvent/biz/eventstaff/edit.js" type="text/javascript"></script>
