...
<html>
  <head>
		<meta charset="UTF-8">
		<title>${systemName } | UserInfo - List</title>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="box">
                                ...
                                <div class="box-body">
                                    <a href="#" class="btn btn-sm btn-info" data-src="add.do" data-toggle="modal" data-target="#modal" data-title="新增用户">新增</a>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <script src="${ctx }/js/iEvent/biz/userinfo/list.js" type="text/javascript"></script>
