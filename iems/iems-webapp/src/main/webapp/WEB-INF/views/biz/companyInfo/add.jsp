...
<html>
  <head>
		<meta charset="UTF-8">
		<title>${systemName } | CompanyInfo - Add</title>
                                  ...
                                  <div class="box-header">
                                    ...
                                    <div class="row box-body">
                                        ...
                                        <div class="col-xs-6 form-group h_90px">
                                            ...
                                            <input type="text" class="form-control" id="name" name="companyAdmin.name" placeholder="输入姓名">
                                        </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <script src="${ctx }/js/iEvent/biz/companyinfo/add.js" type="text/javascript"></script>
