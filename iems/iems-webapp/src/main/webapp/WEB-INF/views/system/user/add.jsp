...
<html>
  <head>
		<meta charset="UTF-8">
		<title>${systemName } | User - Add</title>
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                ...
                                <form role="form" id="form_data" action="save.do" method="post">
                                  <input type="hidden" id="usertype" name="sysUser.usertype" value="com.iems.core.entity.SysUser" >
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <script src="${ctx }/js/iEvent/system/user/add.js" type="text/javascript"></script>
